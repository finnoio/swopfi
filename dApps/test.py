...
test2 = pw.Address(seed = "as1sas22")
...
#     {"amount": int(13100000000), "assetId": "qTtranpN3eE8UDZ5kehxvHHtUggXCMTyANGv3RtvaKi" },{"amount": int(100000000), "assetId": None}], txFee=100900000)
# print(fund)
