...
myAddress = py.Address(seed='venture cement chimney typical assume feature nasty home sister knee section opinion control fabric soccer')
moneySeed = py.Address(seed = "testSwopFitestSwopFitestSwopFi")

transfer = moneySeed.sendWaves(myAddress,int(495000))
