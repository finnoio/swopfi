...
#test2 = pw.Address(seed = str("s22332253212as12asd3sssss"))
...
# invoke = moneySeed.invokeScript(test2.address, "exchanger", [{"type": "integer", "value": int(99997292) },{"type": "integer", "value":int(99990847)}], [{ "amount": 100000000, "assetId": assetId1 }], txFee=1000000)
# print(invoke)
# wait_for_resource_available(invoke["id"],1000)

# invoke = moneySeed.invokeScript(test2.address, "exchanger", [{"type": "integer", "value": int(9998431802) },{"type": "integer", "value":int(9998431802)}], [{ "amount": 10000000000, "assetId": assetId1 }], txFee=1000000)
# print(invoke)
# wait_for_resource_available(invoke["id"],1000)

# invoke = moneySeed.invokeScript(test2.address, "exchanger", [{"type": "integer", "value": int(10096965090) },{"type": "integer", "value":int(10096965090)}], [{ "amount": 10095399564, "assetId": assetId2 }], txFee=1000000)
# print(invoke)                                                                                                                                                                                                                                             
# wait_for_resource_available(invoke["id"],1000)
