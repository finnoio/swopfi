...
fund = moneySeed.invokeScript(test2.address, "fund", [], [
    {"amount": int(20000*1e6), "assetId": assetId1 },{"amount": int(20000*1e6), "assetId": assetId2}], txFee=100900000)
print(fund)
...
#     {"amount": 6000000, "assetId": assetId1},
#     {"amount": 6000000, "assetId": assetId2}], txFee=1000000)
# print(replanish)
# statusreplanish = wait_for_resource_available(
#     replanish["id"], 1000)

invoke = moneySeed.invokeScript(test2.address, "exchanger", [{"type": "integer", "value": int(100) },{"type": "integer", "value":int(99)}], [{ "amount": 100, "assetId": assetId1 }], txFee=1000000)
print(invoke)
